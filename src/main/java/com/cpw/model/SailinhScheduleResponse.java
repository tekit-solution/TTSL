...
public class SailinhScheduleResponse {
	...
	private String voy;
	private String from_Eta;
	private String from_Etd;
	...
	private String voyy;
	private String to_Eta;
	private String to_Etd;
	...
	public String getFrom_Eta() {
		return from_Eta;
	}
	public void setFrom_Eta(String from_Eta) {
		this.from_Eta = from_Eta;
	}
	public String getFrom_Etd() {
		return from_Etd;
	}
	public void setFrom_Etd(String from_Etd) {
		this.from_Etd = from_Etd;
	}
	public String getTo_Eta() {
		return to_Eta;
	}
	public void setTo_Eta(String to_Eta) {
		this.to_Eta = to_Eta;
	}
	public String getTo_Etd() {
		return to_Etd;
	}
	public void setTo_Etd(String to_Etd) {
		this.to_Etd = to_Etd;
	}
	...
	public String toString() {
		return "SailinhScheduleResponse [Schedule_id=" + Schedule_id + ", origin_Location=" + origin_Location
