...
public class PdfCreation {
	...
	public String getCustomeSeal() {
		return customeSeal;
	}
	public void setCustomeSeal(String customeSeal) {
		this.customeSeal = customeSeal;
	}
	...
	public String toString() {
		return "PdfCreation [shipper=" + shipper + ", multi_trans_regNo=" + multi_trans_regNo + ", multi_trans_docNo="
				+ multi_trans_docNo + ", shipperRefrence=" + shipperRefrence + ", consignee=" + consignee
				+ ", branchAddrerss=" + branchAddrerss + ", notifyParty=" + notifyParty + ", placeOfReciept="
				+ placeOfReciept + ", portOfLoading=" + portOfLoading + ", freightPayableAt=" + freightPayableAt
				+ ", vessel=" + vessel + ", portOfDischarge=" + portOfDischarge + ", placeOfDelivery=" + placeOfDelivery
				+ ", noOfOriginalBill=" + noOfOriginalBill + ", descriptionOfGoods=" + descriptionOfGoods
				+ ", grossWeight=" + grossWeight + ", measurement=" + measurement + ", shippedOnBoard=" + shippedOnBoard
				+ ", locationMaster=" + locationMaster + ", currentDate=" + currentDate + ", forTTSL=" + forTTSL
				+ ", shipperAddress=" + shipperAddress + ", consigneeAddress=" + consigneeAddress
				+ ", fristNotifyAddrerss=" + fristNotifyAddrerss + ", markAndNumber=" + markAndNumber + ", containerNo="
				+ containerNo + ", sB_No=" + sB_No + "]";
	}
